...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index_html__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__styles_pcss__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__styles_pcss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__styles_pcss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__App__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__App___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__App__);




const app = __WEBPACK_IMPORTED_MODULE_2__App___default.a.App.embed(document.getElementById('main'));
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js??ref--3-1!../node_modules/postcss-loader/lib/index.js??ref--3-2!./styles.pcss", function() {
			var newContent = require("!!../node_modules/css-loader/index.js??ref--3-1!../node_modules/postcss-loader/lib/index.js??ref--3-2!./styles.pcss");
...
// module
exports.push([module.i, "/*! normalize.css v7.0.0 | MIT License | github.com/necolas/normalize.css */\n\n/* Document\n   ========================================================================== */\n\n/**\n * 1. Correct the line height in all browsers.\n * 2. Prevent adjustments of font size after orientation changes in\n *    IE on Windows Phone and in iOS.\n */\n\nhtml {\n  line-height: 1.15; /* 1 */\n  -ms-text-size-adjust: 100%; /* 2 */\n  -webkit-text-size-adjust: 100%; /* 2 */\n}\n\n/* Sections\n   ========================================================================== */\n\n/**\n * Remove the margin in all browsers (opinionated).\n */\n\nbody {\n  margin: 0;\n}\n\n/**\n * Add the correct display in IE 9-.\n */\n\narticle, aside, footer, header, nav, section {\n  display: block;\n}\n\n/**\n * Correct the font size and margin on `h1` elements within `section` and\n * `article` contexts in Chrome, Firefox, and Safari.\n */\n\nh1 {\n  font-size: 2em;\n  margin: 0.67em 0;\n}\n\n/* Grouping content\n   ========================================================================== */\n\n/**\n * Add the correct display in IE 9-.\n * 1. Add the correct display in IE.\n */\n\nfigcaption, figure, main { /* 1 */\n  display: block;\n}\n\n/**\n * Add the correct margin in IE 8.\n */\n\nfigure {\n  margin: 1em 40px;\n}\n\n/**\n * 1. Add the correct box sizing in Firefox.\n * 2. Show the overflow in Edge and IE.\n */\n\nhr {\n  box-sizing: content-box; /* 1 */\n  height: 0; /* 1 */\n  overflow: visible; /* 2 */\n}\n\n/**\n * 1. Correct the inheritance and scaling of font size in all browsers.\n * 2. Correct the odd `em` font sizing in all browsers.\n */\n\npre {\n  font-family: monospace, monospace; /* 1 */\n  font-size: 1em; /* 2 */\n}\n\n/* Text-level semantics\n   ========================================================================== */\n\n/**\n * 1. Remove the gray background on active links in IE 10.\n * 2. Remove gaps in links underline in iOS 8+ and Safari 8+.\n */\n\na {\n  background-color: transparent; /* 1 */\n  -webkit-text-decoration-skip: objects; /* 2 */\n}\n\n/**\n * 1. Remove the bottom border in Chrome 57- and Firefox 39-.\n * 2. Add the correct text decoration in Chrome, Edge, IE, Opera, and Safari.\n */\n\nabbr[title] {\n  border-bottom: none; /* 1 */\n  text-decoration: underline; /* 2 */\n  text-decoration: underline dotted; /* 2 */\n}\n\n/**\n * Prevent the duplicate application of `bolder` by the next rule in Safari 6.\n */\n\nb, strong {\n  font-weight: inherit;\n}\n\n/**\n * Add the correct font weight in Chrome, Edge, and Safari.\n */\n\nb, strong {\n  font-weight: bolder;\n}\n\n/**\n * 1. Correct the inheritance and scaling of font size in all browsers.\n * 2. Correct the odd `em` font sizing in all browsers.\n */\n\ncode, kbd, samp {\n  font-family: monospace, monospace; /* 1 */\n  font-size: 1em; /* 2 */\n}\n\n/**\n * Add the correct font style in Android 4.3-.\n */\n\ndfn {\n  font-style: italic;\n}\n\n/**\n * Add the correct background and color in IE 9-.\n */\n\nmark {\n  background-color: #ff0;\n  color: #000;\n}\n\n/**\n * Add the correct font size in all browsers.\n */\n\nsmall {\n  font-size: 80%;\n}\n\n/**\n * Prevent `sub` and `sup` elements from affecting the line height in\n * all browsers.\n */\n\nsub, sup {\n  font-size: 75%;\n  line-height: 0;\n  position: relative;\n  vertical-align: baseline;\n}\n\nsub {\n  bottom: -0.25em;\n}\n\nsup {\n  top: -0.5em;\n}\n\n/* Embedded content\n   ========================================================================== */\n\n/**\n * Add the correct display in IE 9-.\n */\n\naudio, video {\n  display: inline-block;\n}\n\n/**\n * Add the correct display in iOS 4-7.\n */\n\naudio:not([controls]) {\n  display: none;\n  height: 0;\n}\n\n/**\n * Remove the border on images inside links in IE 10-.\n */\n\nimg {\n  border-style: none;\n}\n\n/**\n * Hide the overflow in IE.\n */\n\nsvg:not(:root) {\n  overflow: hidden;\n}\n\n/* Forms\n   ========================================================================== */\n\n/**\n * 1. Change the font styles in all browsers (opinionated).\n * 2. Remove the margin in Firefox and Safari.\n */\n\nbutton, input, optgroup, select, textarea {\n  font-family: sans-serif; /* 1 */\n  font-size: 100%; /* 1 */\n  line-height: 1.15; /* 1 */\n  margin: 0; /* 2 */\n}\n\n/**\n * Show the overflow in IE.\n * 1. Show the overflow in Edge.\n */\n\nbutton, input { /* 1 */\n  overflow: visible;\n}\n\n/**\n * Remove the inheritance of text transform in Edge, Firefox, and IE.\n * 1. Remove the inheritance of text transform in Firefox.\n */\n\nbutton, select { /* 1 */\n  text-transform: none;\n}\n\n/**\n * 1. Prevent a WebKit bug where (2) destroys native `audio` and `video`\n *    controls in Android 4.\n * 2. Correct the inability to style clickable types in iOS and Safari.\n */\n\nbutton, html [type=\"button\"], [type=\"reset\"], [type=\"submit\"] {\n  -webkit-appearance: button; /* 2 */\n}\n\n/**\n * Remove the inner border and padding in Firefox.\n */\n\nbutton::-moz-focus-inner, [type=\"button\"]::-moz-focus-inner, [type=\"reset\"]::-moz-focus-inner, [type=\"submit\"]::-moz-focus-inner {\n  border-style: none;\n  padding: 0;\n}\n\n/**\n * Restore the focus styles unset by the previous rule.\n */\n\nbutton:-moz-focusring, [type=\"button\"]:-moz-focusring, [type=\"reset\"]:-moz-focusring, [type=\"submit\"]:-moz-focusring {\n  outline: 1px dotted ButtonText;\n}\n\n/**\n * Correct the padding in Firefox.\n */\n\nfieldset {\n  padding: 0.35em 0.75em 0.625em;\n}\n\n/**\n * 1. Correct the text wrapping in Edge and IE.\n * 2. Correct the color inheritance from `fieldset` elements in IE.\n * 3. Remove the padding so developers are not caught out when they zero out\n *    `fieldset` elements in all browsers.\n */\n\nlegend {\n  box-sizing: border-box; /* 1 */\n  color: inherit; /* 2 */\n  display: table; /* 1 */\n  max-width: 100%; /* 1 */\n  padding: 0; /* 3 */\n  white-space: normal; /* 1 */\n}\n\n/**\n * 1. Add the correct display in IE 9-.\n * 2. Add the correct vertical alignment in Chrome, Firefox, and Opera.\n */\n\nprogress {\n  display: inline-block; /* 1 */\n  vertical-align: baseline; /* 2 */\n}\n\n/**\n * Remove the default vertical scrollbar in IE.\n */\n\ntextarea {\n  overflow: auto;\n}\n\n/**\n * 1. Add the correct box sizing in IE 10-.\n * 2. Remove the padding in IE 10-.\n */\n\n[type=\"checkbox\"], [type=\"radio\"] {\n  box-sizing: border-box; /* 1 */\n  padding: 0; /* 2 */\n}\n\n/**\n * Correct the cursor style of increment and decrement buttons in Chrome.\n */\n\n[type=\"number\"]::-webkit-inner-spin-button, [type=\"number\"]::-webkit-outer-spin-button {\n  height: auto;\n}\n\n/**\n * 1. Correct the odd appearance in Chrome and Safari.\n * 2. Correct the outline style in Safari.\n */\n\n[type=\"search\"] {\n  -webkit-appearance: textfield; /* 1 */\n  outline-offset: -2px; /* 2 */\n}\n\n/**\n * Remove the inner padding and cancel buttons in Chrome and Safari on macOS.\n */\n\n[type=\"search\"]::-webkit-search-cancel-button, [type=\"search\"]::-webkit-search-decoration {\n  -webkit-appearance: none;\n}\n\n/**\n * 1. Correct the inability to style clickable types in iOS and Safari.\n * 2. Change font properties to `inherit` in Safari.\n */\n\n::-webkit-file-upload-button {\n  -webkit-appearance: button; /* 1 */\n  font: inherit; /* 2 */\n}\n\n/* Interactive\n   ========================================================================== */\n\n/*\n * Add the correct display in IE 9-.\n * 1. Add the correct display in Edge, IE, and Firefox.\n */\n\ndetails, menu {\n  display: block;\n}\n\n/*\n * Add the correct display in all browsers.\n */\n\nsummary {\n  display: list-item;\n}\n\n/* Scripting\n   ========================================================================== */\n\n/**\n * Add the correct display in IE 9-.\n */\n\ncanvas {\n  display: inline-block;\n}\n\n/**\n * Add the correct display in IE.\n */\n\ntemplate {\n  display: none;\n}\n\n/* Hidden\n   ========================================================================== */\n\n/**\n * Add the correct display in IE 10-.\n */\n\n[hidden] {\n  display: none;\n}\n\n@font-face {\n    font-family: 'Roboto';\n    src: url(" + __webpack_require__(0) + ");\n    src: local('Roboto Thin'), local('Roboto-Thin'), url(" + __webpack_require__(0) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(12) + ") format('woff2'), url(" + __webpack_require__(13) + ") format('woff'), url(" + __webpack_require__(14) + ") format('truetype'), url(" + __webpack_require__(15) + "#Roboto) format('svg');\n    font-weight: 100;\n    font-style: normal;\n}\n\n@font-face {\n    font-family: 'Roboto-Thin';\n    src: url(" + __webpack_require__(0) + ");\n    src: local('Roboto Thin'), local('Roboto-Thin'), url(" + __webpack_require__(0) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(12) + ") format('woff2'), url(" + __webpack_require__(13) + ") format('woff'), url(" + __webpack_require__(14) + ") format('truetype'), url(" + __webpack_require__(15) + "#Roboto) format('svg');\n}\n\n@font-face {\n    font-family: 'Roboto';\n    src: url(" + __webpack_require__(1) + ");\n    src: local('Roboto ThinItalic'), local('Roboto-ThinItalic'), url(" + __webpack_require__(1) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(16) + ") format('woff2'), url(" + __webpack_require__(17) + ") format('woff'), url(" + __webpack_require__(18) + ") format('truetype'), url(" + __webpack_require__(19) + "#Roboto) format('svg');\n    font-weight: 100;\n    font-style: italic;\n}\n\n@font-face {\n    font-family: 'Roboto-ThinItalic';\n    src: url(" + __webpack_require__(1) + ");\n    src: local('Roboto ThinItalic'), local('Roboto-ThinItalic'), url(" + __webpack_require__(1) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(16) + ") format('woff2'), url(" + __webpack_require__(17) + ") format('woff'), url(" + __webpack_require__(18) + ") format('truetype'), url(" + __webpack_require__(19) + "#Roboto) format('svg');\n}\n\n@font-face {\n    font-family: 'Roboto';\n    src: url(" + __webpack_require__(2) + ");\n    src: local('Roboto Light'), local('Roboto-Light'), url(" + __webpack_require__(2) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(20) + ") format('woff2'), url(" + __webpack_require__(21) + ") format('woff'), url(" + __webpack_require__(22) + ") format('truetype'), url(" + __webpack_require__(23) + "#Roboto) format('svg');\n    font-weight: 300;\n    font-style: normal;\n}\n\n@font-face {\n    font-family: 'Roboto-Light';\n    src: url(" + __webpack_require__(2) + ");\n    src: local('Roboto Light'), local('Roboto-Light'), url(" + __webpack_require__(2) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(20) + ") format('woff2'), url(" + __webpack_require__(21) + ") format('woff'), url(" + __webpack_require__(22) + ") format('truetype'), url(" + __webpack_require__(23) + "#Roboto) format('svg');\n}\n\n@font-face {\n    font-family: 'Roboto';\n    src: url(" + __webpack_require__(3) + ");\n    src: local('Roboto LightItalic'), local('Roboto-LightItalic'), url(" + __webpack_require__(3) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(24) + ") format('woff2'), url(" + __webpack_require__(25) + ") format('woff'), url(" + __webpack_require__(26) + ") format('truetype'), url(" + __webpack_require__(27) + "#Roboto) format('svg');\n    font-weight: 300;\n    font-style: italic;\n}\n\n@font-face {\n    font-family: 'Roboto-LightItalic';\n    src: url(" + __webpack_require__(3) + ");\n    src: local('Roboto LightItalic'), local('Roboto-LightItalic'), url(" + __webpack_require__(3) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(24) + ") format('woff2'), url(" + __webpack_require__(25) + ") format('woff'), url(" + __webpack_require__(26) + ") format('truetype'), url(" + __webpack_require__(27) + "#Roboto) format('svg');\n}\n\n@font-face {\n    font-family: 'Roboto';\n    src: url(" + __webpack_require__(4) + ");\n    src: local('Roboto Regular'), local('Roboto-Regular'), url(" + __webpack_require__(4) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(28) + ") format('woff2'), url(" + __webpack_require__(29) + ") format('woff'), url(" + __webpack_require__(30) + ") format('truetype'), url(" + __webpack_require__(31) + "#Roboto) format('svg');\n    font-weight: 400;\n    font-style: normal;\n}\n\n@font-face {\n    font-family: 'Roboto-Regular';\n    src: url(" + __webpack_require__(4) + ");\n    src: local('Roboto Regular'), local('Roboto-Regular'), url(" + __webpack_require__(4) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(28) + ") format('woff2'), url(" + __webpack_require__(29) + ") format('woff'), url(" + __webpack_require__(30) + ") format('truetype'), url(" + __webpack_require__(31) + "#Roboto) format('svg');\n}\n\n@font-face {\n    font-family: 'Roboto';\n    src: url(" + __webpack_require__(5) + ");\n    src: local('Roboto RegularItalic'), local('Roboto-RegularItalic'), url(" + __webpack_require__(5) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(32) + ") format('woff2'), url(" + __webpack_require__(33) + ") format('woff'), url(" + __webpack_require__(34) + ") format('truetype'), url(" + __webpack_require__(35) + "#Roboto) format('svg');\n    font-weight: 400;\n    font-style: italic;\n}\n\n@font-face {\n    font-family: 'Roboto-RegularItalic';\n    src: url(" + __webpack_require__(5) + ");\n    src: local('Roboto RegularItalic'), local('Roboto-RegularItalic'), url(" + __webpack_require__(5) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(32) + ") format('woff2'), url(" + __webpack_require__(33) + ") format('woff'), url(" + __webpack_require__(34) + ") format('truetype'), url(" + __webpack_require__(35) + "#Roboto) format('svg');\n}\n\n@font-face {\n    font-family: 'Roboto';\n    src: url(" + __webpack_require__(6) + ");\n    src: local('Roboto Medium'), local('Roboto-Medium'), url(" + __webpack_require__(6) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(36) + ") format('woff2'), url(" + __webpack_require__(37) + ") format('woff'), url(" + __webpack_require__(38) + ") format('truetype'), url(" + __webpack_require__(39) + "#Roboto) format('svg');\n    font-weight: 500;\n    font-style: normal;\n}\n\n@font-face {\n    font-family: 'Roboto-Medium';\n    src: url(" + __webpack_require__(6) + ");\n    src: local('Roboto Medium'), local('Roboto-Medium'), url(" + __webpack_require__(6) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(36) + ") format('woff2'), url(" + __webpack_require__(37) + ") format('woff'), url(" + __webpack_require__(38) + ") format('truetype'), url(" + __webpack_require__(39) + "#Roboto) format('svg');\n}\n\n@font-face {\n    font-family: 'Roboto';\n    src: url(" + __webpack_require__(7) + ");\n    src: local('Roboto MediumItalic'), local('Roboto-MediumItalic'), url(" + __webpack_require__(7) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(40) + ") format('woff2'), url(" + __webpack_require__(41) + ") format('woff'), url(" + __webpack_require__(42) + ") format('truetype'), url(" + __webpack_require__(43) + "#Roboto) format('svg');\n    font-weight: 500;\n    font-style: italic;\n}\n\n@font-face {\n    font-family: 'Roboto-MediumItalic';\n    src: url(" + __webpack_require__(7) + ");\n    src: local('Roboto MediumItalic'), local('Roboto-MediumItalic'), url(" + __webpack_require__(7) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(40) + ") format('woff2'), url(" + __webpack_require__(41) + ") format('woff'), url(" + __webpack_require__(42) + ") format('truetype'), url(" + __webpack_require__(43) + "#Roboto) format('svg');\n}\n\n@font-face {\n    font-family: 'Roboto';\n    src: url(" + __webpack_require__(8) + ");\n    src: local('Roboto Bold'), local('Roboto-Bold'), url(" + __webpack_require__(8) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(44) + ") format('woff2'), url(" + __webpack_require__(45) + ") format('woff'), url(" + __webpack_require__(46) + ") format('truetype'), url(" + __webpack_require__(47) + "#Roboto) format('svg');\n    font-weight: 700;\n    font-style: normal;\n}\n\n@font-face {\n    font-family: 'Roboto-Bold';\n    src: url(" + __webpack_require__(8) + ");\n    src: local('Roboto Bold'), local('Roboto-Bold'), url(" + __webpack_require__(8) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(44) + ") format('woff2'), url(" + __webpack_require__(45) + ") format('woff'), url(" + __webpack_require__(46) + ") format('truetype'), url(" + __webpack_require__(47) + "#Roboto) format('svg');\n}\n\n@font-face {\n    font-family: 'Roboto';\n    src: url(" + __webpack_require__(9) + ");\n    src: local('Roboto BoldItalic'), local('Roboto-BoldItalic'), url(" + __webpack_require__(9) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(48) + ") format('woff2'), url(" + __webpack_require__(49) + ") format('woff'), url(" + __webpack_require__(50) + ") format('truetype'), url(" + __webpack_require__(51) + "#Roboto) format('svg');\n    font-weight: 700;\n    font-style: italic;\n}\n\n@font-face {\n    font-family: 'Roboto-BoldItalic';\n    src: url(" + __webpack_require__(9) + ");\n    src: local('Roboto BoldItalic'), local('Roboto-BoldItalic'), url(" + __webpack_require__(9) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(48) + ") format('woff2'), url(" + __webpack_require__(49) + ") format('woff'), url(" + __webpack_require__(50) + ") format('truetype'), url(" + __webpack_require__(51) + "#Roboto) format('svg');\n}\n\n@font-face {\n    font-family: 'Roboto';\n    src: url(" + __webpack_require__(10) + ");\n    src: local('Roboto Black'), local('Roboto-Black'), url(" + __webpack_require__(10) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(52) + ") format('woff2'), url(" + __webpack_require__(53) + ") format('woff'), url(" + __webpack_require__(54) + ") format('truetype'), url(" + __webpack_require__(55) + "#Roboto) format('svg');\n    font-weight: 900;\n    font-style: normal;\n}\n\n@font-face {\n    font-family: 'Roboto-Black';\n    src: url(" + __webpack_require__(10) + ");\n    src: local('Roboto Black'), local('Roboto-Black'), url(" + __webpack_require__(10) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(52) + ") format('woff2'), url(" + __webpack_require__(53) + ") format('woff'), url(" + __webpack_require__(54) + ") format('truetype'), url(" + __webpack_require__(55) + "#Roboto) format('svg');\n}\n\n@font-face {\n    font-family: 'Roboto';\n    src: url(" + __webpack_require__(11) + ");\n    src: local('Roboto BlackItalic'), local('Roboto-BlackItalic'), url(" + __webpack_require__(11) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(56) + ") format('woff2'), url(" + __webpack_require__(57) + ") format('woff'), url(" + __webpack_require__(58) + ") format('truetype'), url(" + __webpack_require__(59) + "#Roboto) format('svg');\n    font-weight: 900;\n    font-style: italic;\n}\n\n@font-face {\n    font-family: 'Roboto-BlackItalic';\n    src: url(" + __webpack_require__(11) + ");\n    src: local('Roboto BlackItalic'), local('Roboto-BlackItalic'), url(" + __webpack_require__(11) + "?#iefix) format('embedded-opentype'), url(" + __webpack_require__(56) + ") format('woff2'), url(" + __webpack_require__(57) + ") format('woff'), url(" + __webpack_require__(58) + ") format('truetype'), url(" + __webpack_require__(59) + "#Roboto) format('svg');\n}\n\nbody {\n    font-size: 16px;\n    font-family: Roboto, sans-serif;\n}\n\nbody * {\n    box-sizing: border-box;\n}\n\n.app {\n    width: 1240px;\n    margin: 0 auto;\n}\n\n.app__component + .app__component {\n        margin-top: 15px;\n    }\n\n.app__header {\n    background-color: #2196F3;\n    color: #fff;\n    padding: 20px;\n}\n\n.app__timelines {\n    position: relative;\n}\n\n.timeline {\n    height: 50px;\n    display: -ms-flexbox;\n    display: flex;\n    -ms-flex-pack: justify;\n        justify-content: space-between;\n    border-top: 2px solid black;\n    position: relative;\n}\n\n.timeline--not-matches-meeting::after {\n    content: '';\n    position: absolute;\n    top: 0;\n    right: 0;\n    bottom: 0;\n    left: 0;\n    background-color: #c00;\n    opacity: 0.3;\n}\n\n.timeline__item {\n    -ms-flex: 1 1 0px;\n        flex: 1 1 0;\n    display: -ms-flexbox;\n    display: flex;\n    -ms-flex-align: center;\n        align-items: center;\n    -ms-flex-pack: center;\n        justify-content: center;\n    position: relative;\n}\n\n.timeline__item--good {\n    background-color: #81C784;\n}\n\n.timeline__item--bad {\n    background-color: #E57373;\n}\n\n.timeline__item::before {\n    content: '';\n    width: 0;\n    height: 5px;\n    border-left: 1px solid black;\n    top: 0;\n    left: 0;\n    position: absolute;\n}\n\n.timeline__item:last-child::after {\n    content: '';\n    width: 0;\n    height: 5px;\n    border-left: 1px solid black;\n    top: 0;\n    right: 0;\n    position: absolute;\n}\n\n.meeting-indicator {\n    background-color: #008fff;\n    border: 2px solid #004478;\n    opacity: 0.3;\n    top: 0;\n    bottom: 0;\n    left: 10%;\n    width: 10%;\n    position: absolute;\n    z-index: 1;\n\n    transition: left 350ms, width 350ms;\n}\n\n.autocomplete-menu {\n    position: absolute;\n    background: white;\n    color: black;\n    border: 1px solid #DDD;\n    border-radius: 3px;\n    box-shadow: 0 0 5px rgba(0, 0, 0, .1);\n    min-width: 120px;\n    z-index: 11110;\n    width: 100%;\n}\n\n.autocomplete-list {\n    list-style: none;\n    padding: 0;\n    margin: auto;\n    max-height: 200px;\n    overflow-y: auto;\n}\n\n.autocomplete-item {\n    display: block;\n    padding: 5px 10px;\n    border-bottom: 1px solid #DDD;\n    cursor: pointer;\n}\n\n.autocomplete-input {\n    width: 100%;\n}\n\n.city-selector {\n    position: relative;\n    display: inline-block;\n    width: 300px;\n}\n", ""]);
...
var _user$project$Header$view = function (attributes) {
	return A2(
			...
			attributes),
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Time picker for meetings in different time zones'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$MeetingIndicator$view = F2(
	function (start, duration) {
		var width = (100 / 24) * duration;
		var left = (100 / 24) * start;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('meeting-indicator'),
				_1: {
					ctor: '::',
...
var _user$project$App_NumberInput$subscription = function (model) {
	return model.inputSub;
};
var _user$project$App_NumberInput$init = {inputSub: _elm_lang$core$Platform_Sub$none, overrideValue: ''};
var _user$project$App_NumberInput$inputKeyCodeToMsg = F2(
	function (onInc, onDec) {
		return A2(
			_elm_lang$core$Json_Decode$andThen,
			function (result) {
				var _p0 = result;
			...
			A2(
				_elm_lang$core$Json_Decode$map,
				function (code) {
					return _elm_lang$core$Native_Utils.eq(code, 38) ? _elm_lang$core$Result$Ok(onInc) : (_elm_lang$core$Native_Utils.eq(code, 40) ? _elm_lang$core$Result$Ok(onDec) : _elm_lang$core$Result$Err('not handling that key'));
				},
				_elm_lang$html$Html_Events$keyCode));
	});
var _user$project$App_NumberInput$wheelEventToMessage = F2(
	function (onInc, onDec) {
		return A2(
			_elm_lang$core$Json_Decode$map,
			function (delta) {
				return (_elm_lang$core$Native_Utils.cmp(delta, 0) > 0) ? onDec : onInc;
			},
			A2(_elm_lang$core$Json_Decode$field, 'deltaY', _elm_lang$core$Json_Decode$int));
	});
var _user$project$App_NumberInput$Model = F2(
	function (a, b) {
		return {inputSub: a, overrideValue: b};
	});
var _user$project$App_NumberInput$SetOverrideValue = function (a) {
	return {ctor: 'SetOverrideValue', _0: a};
};
var _user$project$App_NumberInput$inputChangeToMsg = F3(
	function (onShift, currentValue, stringValue) {
		return (_elm_lang$core$Native_Utils.eq(stringValue, '-') || _elm_lang$core$Native_Utils.eq(stringValue, '+')) ? _user$project$App_NumberInput$SetOverrideValue(stringValue) : (_elm_lang$core$Native_Utils.eq(stringValue, '0-') ? _user$project$App_NumberInput$SetOverrideValue('-') : (_elm_lang$core$Native_Utils.eq(stringValue, '0+') ? _user$project$App_NumberInput$SetOverrideValue('+') : (_elm_lang$core$Native_Utils.eq(stringValue, '') ? onShift(0 - currentValue) : onShift(
			A2(
				_elm_lang$core$Result$withDefault,
				currentValue,
				_elm_lang$core$String$toFloat(stringValue)) - currentValue))));
	});
var _user$project$App_NumberInput$StartRepeat = function (a) {
	return {ctor: 'StartRepeat', _0: a};
};
var _user$project$App_NumberInput$Do = function (a) {
	return {ctor: 'Do', _0: a};
};
var _user$project$App_NumberInput$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'StartRepeat':
				var _p4 = _p1._0;
				var _p2 = A2(
					_user$project$App_NumberInput$update,
					_user$project$App_NumberInput$Do(_p4),
					model);
				var updatedModel = _p2._0;
				var updateCmd = _p2._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						updatedModel,
						{
							inputSub: A2(
								...
								function (_p3) {
									return A2(_elm_lang$core$Debug$log, 'payload', _p4);
								})
						}),
					{
						ctor: '::',
			...
			case 'EndRepeat':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{inputSub: _elm_lang$core$Platform_Sub$none}),
					{ctor: '[]'});
			case 'Do':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			default:
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{overrideValue: _p1._0}),
					{ctor: '[]'});
		}
	});
var _user$project$App_NumberInput$EndRepeat = {ctor: 'EndRepeat'};
var _user$project$App_NumberInput$view = F4(
	function (model, currentValue, step, onShift) {
		var onDec = onShift(0 - step);
		var onInc = onShift(step);
		return A2(
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_0: _elm_lang$html$Html_Attributes$value(
							(!_elm_lang$core$Native_Utils.eq(model.overrideValue, '')) ? model.overrideValue : _elm_lang$core$Basics$toString(currentValue)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html_Events$on,
								'wheel',
								A2(
									_user$project$App_NumberInput$wheelEventToMessage,
									_user$project$App_NumberInput$Do(onInc),
									_user$project$App_NumberInput$Do(onDec))),
							_1: {
								ctor: '::',
								_0: A3(
									_elm_lang$html$Html_Events$onWithOptions,
									...
									A2(
										_user$project$App_NumberInput$inputKeyCodeToMsg,
										_user$project$App_NumberInput$Do(onInc),
										_user$project$App_NumberInput$Do(onDec))),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(
										A2(
											_user$project$App_NumberInput$inputChangeToMsg,
											function (v) {
												return _user$project$App_NumberInput$Do(
													onShift(v));
											},
											currentValue)),
									_1: {ctor: '[]'}
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_0: _elm_lang$html$Html_Events$onMouseDown(
								_user$project$App_NumberInput$StartRepeat(onInc)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onMouseUp(_user$project$App_NumberInput$EndRepeat),
								_1: {ctor: '[]'}
							}
						},
						{
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onMouseDown(
									_user$project$App_NumberInput$StartRepeat(onDec)),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onMouseUp(_user$project$App_NumberInput$EndRepeat),
									_1: {ctor: '[]'}
...
var _user$project$MeetingTimeSelector$subsctiption = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: model.startTimeInput.inputSub,
			_1: {
				ctor: '::',
				_0: model.durationInput.inputSub,
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$MeetingTimeSelector$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ShiftStartTime':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{startTime: model.startTime + _p0._0}),
					{ctor: '[]'});
			case 'ShiftDuration':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{duration: model.duration + _p0._0}),
					{ctor: '[]'});
			case 'StartTimeNumberInputMsg':
				var _p1 = A2(_user$project$App_NumberInput$update, _p0._0, model.startTimeInput);
				var updatedModel = _p1._0;
				var updateCmd = _p1._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{startTimeInput: updatedModel}),
					{
						ctor: '::',
						_0: updateCmd,
						_1: {ctor: '[]'}
			...
			default:
				var _p2 = A2(_user$project$App_NumberInput$update, _p0._0, model.durationInput);
				var updatedModel = _p2._0;
				var updateCmd = _p2._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$MeetingTimeSelector$Model = F4(
	function (a, b, c, d) {
		return {startTimeInput: a, durationInput: b, startTime: c, duration: d};
	});
var _user$project$MeetingTimeSelector$init = A4(_user$project$MeetingTimeSelector$Model, _user$project$App_NumberInput$init, _user$project$App_NumberInput$init, 17, 1);
var _user$project$MeetingTimeSelector$ShiftDuration = function (a) {
	return {ctor: 'ShiftDuration', _0: a};
};
var _user$project$MeetingTimeSelector$ShiftStartTime = function (a) {
	return {ctor: 'ShiftStartTime', _0: a};
};
var _user$project$MeetingTimeSelector$DurationNumberInputMsg = function (a) {
	return {ctor: 'DurationNumberInputMsg', _0: a};
};
var _user$project$MeetingTimeSelector$StartTimeNumberInputMsg = function (a) {
	return {ctor: 'StartTimeNumberInputMsg', _0: a};
};
var _user$project$MeetingTimeSelector$view = F2(
		...
		return A2(
				...
				attributes),
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Start time (UTC +0)'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$map,
						_user$project$MeetingTimeSelector$StartTimeNumberInputMsg,
						A4(_user$project$App_NumberInput$view, model.startTimeInput, model.startTime, 0.25, _user$project$MeetingTimeSelector$ShiftStartTime)),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$span,
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$map,
								_user$project$MeetingTimeSelector$DurationNumberInputMsg,
								A4(_user$project$App_NumberInput$view, model.durationInput, model.duration, 0.25, _user$project$MeetingTimeSelector$ShiftDuration)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$TeleportCitiesSuggestions$extractCityIdFromUrl = function (url) {
	var endPosition = A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		_elm_lang$core$List$head(
			_elm_lang$core$List$reverse(
				A2(_elm_lang$core$String$indexes, '/', url))));
	var startPosition = A2(
		F2(
			function (x, y) {
				return x + y;
			}),
		_elm_lang$core$String$length('geonameid:'),
		A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			_elm_lang$core$List$head(
				A2(_elm_lang$core$String$indexes, 'geonameid:', url))));
	return A3(_elm_lang$core$String$slice, startPosition, endPosition, url);
};
var _user$project$TeleportCitiesSuggestions$getSuggestionsUrl = function (query) {
	return A2(_elm_lang$core$Basics_ops['++'], 'https://api.teleport.org/api/cities/?search=', query);
};
var _user$project$TeleportCitiesSuggestions$Suggestion = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _user$project$TeleportCitiesSuggestions$decodeSuggestions = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: '_embedded',
	...
	_elm_lang$core$Json_Decode$list(
		A3(
			_elm_lang$core$Json_Decode$map2,
			_user$project$TeleportCitiesSuggestions$Suggestion,
			A2(
				_elm_lang$core$Json_Decode$at,
				{
					ctor: '::',
				...
				A2(
					_elm_lang$core$Json_Decode$field,
					'href',
					A2(_elm_lang$core$Json_Decode$map, _user$project$TeleportCitiesSuggestions$extractCityIdFromUrl, _elm_lang$core$Json_Decode$string))),
			A2(_elm_lang$core$Json_Decode$field, 'matching_full_name', _elm_lang$core$Json_Decode$string))));
var _user$project$TeleportCitiesSuggestions$suggest = F2(
	function (resultToMessage, query) {
		return A2(
			...
			function (result) {
				...
				if (_p0.ctor === 'Ok') {
					return resultToMessage(
						A2(_elm_lang$core$Debug$log, 'values', _p0._0));
				} else {
					return resultToMessage(
						{ctor: '[]'});
				}
			...
			A2(
				...
				_user$project$TeleportCitiesSuggestions$getSuggestionsUrl(query),
				_user$project$TeleportCitiesSuggestions$decodeSuggestions));
	});

var _user$project$TeleportCityTimeZoneResolver$decodeTimeZoneShift = A2(_elm_lang$core$Json_Decode$field, 'base_offset_min', _elm_lang$core$Json_Decode$int);
var _user$project$TeleportCityTimeZoneResolver$decodeCityTimeZoneName = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: '_links',
...
var _user$project$TeleportCityTimeZoneResolver$getTimezoneUrl = function (name) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'https://api.teleport.org/api/timezones/iana:',
		A2(
			_elm_lang$core$Basics_ops['++'],
			A2(
				_elm_lang$core$String$join,
			...
			'/offsets/?date=2017-07-04T00:49:22Z'));
};
var _user$project$TeleportCityTimeZoneResolver$getCityDetailsUrl = function (code) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'https://api.teleport.org/api/cities/geonameid:',
		A2(_elm_lang$core$Basics_ops['++'], code, '/'));
};
var _user$project$TeleportCityTimeZoneResolver$resolveTimeZone = F2(
	function (resultToMessage, query) {
		return A2(
			_elm_lang$core$Task$attempt,
			function (result) {
				var _p0 = result;
				if (_p0.ctor === 'Ok') {
					return resultToMessage(_p0._0);
				} else {
					return resultToMessage(-100);
				}
			},
			A2(
				_elm_lang$core$Task$andThen,
				function (shift) {
					return _elm_lang$core$Task$succeed((shift / 60) | 0);
				},
				A2(
					_elm_lang$core$Task$andThen,
					function (tzName) {
						return _elm_lang$http$Http$toTask(
							A2(
								_elm_lang$http$Http$get,
								_user$project$TeleportCityTimeZoneResolver$getTimezoneUrl(tzName),
								_user$project$TeleportCityTimeZoneResolver$decodeTimeZoneShift));
					},
					_elm_lang$http$Http$toTask(
						A2(
							_elm_lang$http$Http$get,
							_user$project$TeleportCityTimeZoneResolver$getCityDetailsUrl(query),
							_user$project$TeleportCityTimeZoneResolver$decodeCityTimeZoneName)))));
	});
var _user$project$TeleportCityTimeZoneResolver$Suggestion = F2(
	function (a, b) {
		return {id: a, name: b};
	});

var _user$project$CitySelector$viewConfig = function () {
	var customizedLi = F3(
		function (keySelected, mouseSelected, place) {
			return {
				attributes: {
					ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id(place.placeId),
						_1: {ctor: '[]'}
					}
				},
				children: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(place.description),
					_1: {ctor: '[]'}
				}
			};
		});
...
var _user$project$CitySelector$acceptablePlaces = F2(
	function (query, places) {
		return places;
	});
var _user$project$CitySelector$resetMenu = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{autoState: _thebritican$elm_autocomplete$Autocomplete$empty, showMenu: false});
};
var _user$project$CitySelector$removeSelection = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{selectedPlace: _elm_lang$core$Maybe$Nothing});
};
var _user$project$CitySelector$resetInput = function (model) {
	return _user$project$CitySelector$resetMenu(
		_user$project$CitySelector$removeSelection(
			_elm_lang$core$Native_Utils.update(
				model,
				{query: ''})));
};
var _user$project$CitySelector$init = {
	places: {ctor: '[]'},
	...
	selectedPlace: _elm_lang$core$Maybe$Nothing,
	showMenu: false,
	d: _bcardiff$elm_debounce$Debounce$init,
	timezone: 0
};
var _user$project$CitySelector$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {places: a, autoState: b, howManyToShow: c, query: d, selectedPlace: e, showMenu: f, d: g, timezone: h};
	});
var _user$project$CitySelector$Place = F2(
	function (a, b) {
		return {description: a, placeId: b};
	});
var _user$project$CitySelector$getPlaceAtId = F2(
	function (places, id) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			A2(_user$project$CitySelector$Place, 'Not Found', ''),
			_elm_lang$core$List$head(
				A2(
					_elm_lang$core$List$filter,
					function (place) {
						return _elm_lang$core$Native_Utils.eq(place.placeId, id);
					},
					places)));
	});
var _user$project$CitySelector$setQuery = F2(
	function (model, id) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				query: function (_) {
					...
					A2(_user$project$CitySelector$getPlaceAtId, model.places, id)),
				selectedPlace: _elm_lang$core$Maybe$Just(
					A2(_user$project$CitySelector$getPlaceAtId, model.places, id))
			});
	});
var _user$project$CitySelector$NoOp = {ctor: 'NoOp'};
var _user$project$CitySelector$GotTimezone = function (a) {
	return {ctor: 'GotTimezone', _0: a};
};
var _user$project$CitySelector$getTimezone = function (query) {
	return A2(_user$project$TeleportCityTimeZoneResolver$resolveTimeZone, _user$project$CitySelector$GotTimezone, query);
};
var _user$project$CitySelector$GetSuggestions = {ctor: 'GetSuggestions'};
var _user$project$CitySelector$Deb = function (a) {
	return {ctor: 'Deb', _0: a};
};
var _user$project$CitySelector$cfg = A4(
	...
	_user$project$CitySelector$Deb,
	500);
var _user$project$CitySelector$deb1 = _bcardiff$elm_debounce$Debounce$debounce1(_user$project$CitySelector$cfg);
var _user$project$CitySelector$debCmd = _bcardiff$elm_debounce$Debounce$debounceCmd(_user$project$CitySelector$cfg);
var _user$project$CitySelector$OnFocus = {ctor: 'OnFocus'};
var _user$project$CitySelector$GotSuggestions = function (a) {
	return {ctor: 'GotSuggestions', _0: a};
};
var _user$project$CitySelector$getSuggestions = function (query) {
	return A2(_user$project$TeleportCitiesSuggestions$suggest, _user$project$CitySelector$GotSuggestions, query);
};
var _user$project$CitySelector$PreviewPlace = function (a) {
	return {ctor: 'PreviewPlace', _0: a};
};
var _user$project$CitySelector$SelectPlaceMouse = function (a) {
	return {ctor: 'SelectPlaceMouse', _0: a};
};
var _user$project$CitySelector$SelectPlaceKeyboard = function (a) {
	return {ctor: 'SelectPlaceKeyboard', _0: a};
};
var _user$project$CitySelector$HandleEscape = {ctor: 'HandleEscape'};
var _user$project$CitySelector$Reset = {ctor: 'Reset'};
var _user$project$CitySelector$Wrap = function (a) {
	return {ctor: 'Wrap', _0: a};
};
var _user$project$CitySelector$updateConfig = _thebritican$elm_autocomplete$Autocomplete$updateConfig(
	{
		toId: function (_) {
			return _.placeId;
		},
		onKeyDown: F2(
			function (code, maybeId) {
				return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? A2(_elm_lang$core$Maybe$map, _user$project$CitySelector$PreviewPlace, maybeId) : (_elm_lang$core$Native_Utils.eq(code, 13) ? A2(_elm_lang$core$Maybe$map, _user$project$CitySelector$SelectPlaceKeyboard, maybeId) : _elm_lang$core$Maybe$Just(_user$project$CitySelector$Reset));
			}),
		onTooLow: _elm_lang$core$Maybe$Just(
			_user$project$CitySelector$Wrap(false)),
		onTooHigh: _elm_lang$core$Maybe$Just(
			_user$project$CitySelector$Wrap(true)),
		onMouseEnter: function (id) {
			return _elm_lang$core$Maybe$Just(
				_user$project$CitySelector$PreviewPlace(id));
		},
		...
		onMouseClick: function (id) {
			return _elm_lang$core$Maybe$Just(
				_user$project$CitySelector$SelectPlaceMouse(
					A2(_elm_lang$core$Debug$log, 'selectedId', id)));
		},
		separateSelections: false
	});
var _user$project$CitySelector$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p1 = msg;
			switch (_p1.ctor) {
				case 'SetQuery':
					var _p3 = _p1._0;
					var showMenu = function (_p2) {
						return !_elm_lang$core$List$isEmpty(_p2);
					}(
						A2(_user$project$CitySelector$acceptablePlaces, _p3, model.places));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{query: _p3, showMenu: true, selectedPlace: _elm_lang$core$Maybe$Nothing}),
						{
							ctor: '::',
							_0: _user$project$CitySelector$debCmd(_user$project$CitySelector$GetSuggestions),
							_1: {ctor: '[]'}
						});
				case 'GetSuggestions':
					return A2(
						...
						{
							ctor: '::',
							_0: _user$project$CitySelector$getSuggestions(model.query),
							_1: {ctor: '[]'}
						});
				case 'Deb':
					return A3(_bcardiff$elm_debounce$Debounce$update, _user$project$CitySelector$cfg, _p1._0, model);
				case 'GotSuggestions':
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								places: A2(
									_elm_lang$core$List$map,
									function (suggestion) {
										return A2(_user$project$CitySelector$Place, suggestion.name, suggestion.id);
									},
									_p1._0)
							}),
				...
				case 'SetAutoState':
					var _p4 = A5(
						...
						_user$project$CitySelector$updateConfig,
						_p1._0,
						model.howManyToShow,
						model.autoState,
						A2(_user$project$CitySelector$acceptablePlaces, model.query, model.places));
					var newState = _p4._0;
					var maybeMsg = _p4._1;
				...
				case 'HandleEscape':
					var validOptions = !_elm_lang$core$List$isEmpty(
						A2(_user$project$CitySelector$acceptablePlaces, model.query, model.places));
					var handleEscape = validOptions ? _user$project$CitySelector$resetMenu(
						_user$project$CitySelector$removeSelection(model)) : _user$project$CitySelector$resetInput(model);
					var escapedModel = function () {
						var _p6 = model.selectedPlace;
						if (_p6.ctor === 'Just') {
							return _elm_lang$core$Native_Utils.eq(model.query, _p6._0.description) ? _user$project$CitySelector$resetInput(model) : handleEscape;
						} else {
							return handleEscape;
						}
					}();
					return A2(
						...
						{ctor: '[]'});
				case 'Wrap':
					var _p7 = model.selectedPlace;
					if (_p7.ctor === 'Just') {
						var _v6 = _user$project$CitySelector$Reset,
							_v7 = model;
						msg = _v6;
						model = _v7;
						continue update;
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									autoState: A4(
										...
										model.howManyToShow,
										model.autoState),
									selectedPlace: _elm_lang$core$List$head(
										_elm_lang$core$List$reverse(
											A2(
												_elm_lang$core$List$take,
												model.howManyToShow,
				...
				case 'Reset':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								autoState: A2(_thebritican$elm_autocomplete$Autocomplete$reset, _user$project$CitySelector$updateConfig, model.autoState),
								selectedPlace: _elm_lang$core$Maybe$Nothing
							}),
						{ctor: '[]'});
				case 'SelectPlaceKeyboard':
					var _p8 = _p1._0;
					var newModel = _user$project$CitySelector$resetMenu(
						A2(_user$project$CitySelector$setQuery, model, _p8));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						newModel,
						{
							ctor: '::',
							_0: _user$project$CitySelector$getTimezone(_p8),
							_1: {ctor: '[]'}
						});
				case 'SelectPlaceMouse':
					var _p10 = _p1._0;
					var newModel = _user$project$CitySelector$resetMenu(
						A2(_user$project$CitySelector$setQuery, model, _p10));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						newModel,
						{
							...
							_0: A2(
								_elm_lang$core$Task$attempt,
								function (_p9) {
									return _user$project$CitySelector$NoOp;
								},
								_elm_lang$dom$Dom$focus('city-input')),
							_1: {
								ctor: '::',
								_0: _user$project$CitySelector$getTimezone(_p10),
								_1: {ctor: '[]'}
							}
						});
				case 'PreviewPlace':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								selectedPlace: _elm_lang$core$Maybe$Just(
									A2(_user$project$CitySelector$getPlaceAtId, model.places, _p1._0))
							}),
						{ctor: '[]'});
				case 'OnFocus':
					return A2(
...
var _user$project$CitySelector$SetAutoState = function (a) {
	return {ctor: 'SetAutoState', _0: a};
};
var _user$project$CitySelector$viewMenu = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$map,
				_user$project$CitySelector$SetAutoState,
				A4(
					_thebritican$elm_autocomplete$Autocomplete$view,
					_user$project$CitySelector$viewConfig,
					model.howManyToShow,
					model.autoState,
					A2(_user$project$CitySelector$acceptablePlaces, model.query, model.places))),
			_1: {ctor: '[]'}
...
var _user$project$CitySelector$SetQuery = function (a) {
	return {ctor: 'SetQuery', _0: a};
};
var _user$project$CitySelector$view = function (model) {
	var query = function () {
		var _p11 = model.selectedPlace;
		if (_p11.ctor === 'Just') {
	...
	var menu = model.showMenu ? {
		ctor: '::',
		_0: _user$project$CitySelector$viewMenu(model),
		_1: {ctor: '[]'}
	} : {ctor: '[]'};
	...
	var dec = A2(
		...
		A2(
			_elm_lang$core$Json_Decode$map,
			function (code) {
				return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? _elm_lang$core$Result$Ok(_user$project$CitySelector$NoOp) : (_elm_lang$core$Native_Utils.eq(code, 27) ? _elm_lang$core$Result$Ok(_user$project$CitySelector$HandleEscape) : _elm_lang$core$Result$Err('not handling that key'));
			},
			_elm_lang$html$Html_Events$keyCode));
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('city-selector'),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$List$append,
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$CitySelector$SetQuery),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onFocus(_user$project$CitySelector$OnFocus),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('city-input'),
										_1: {
											ctor: '::',
...
var _user$project$Participant$subsctiption = function (model) {
	return model.numberInput.inputSub;
};
var _user$project$Participant$Model = F5(
	function (a, b, c, d, e) {
		return {timeZone: a, goodHours: b, isManual: c, city: d, numberInput: e};
	});
var _user$project$Participant$init = A5(
	_user$project$Participant$Model,
	0,
	A2(_elm_lang$core$List$range, 9, 17),
	false,
	_user$project$CitySelector$init,
	_user$project$App_NumberInput$init);
var _user$project$Participant$NumberInputMsg = function (a) {
	return {ctor: 'NumberInputMsg', _0: a};
};
var _user$project$Participant$CityMsg = function (a) {
	return {ctor: 'CityMsg', _0: a};
};
var _user$project$Participant$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Remove':
			...
			case 'ShiftTimeZone':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{timeZone: model.timeZone + _p0._0}),
					{ctor: '[]'});
			case 'ToggleManual':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					...
					{ctor: '[]'});
			case 'NumberInputMsg':
				var _p1 = A2(_user$project$App_NumberInput$update, _p0._0, model.numberInput);
				var updatedModel = _p1._0;
				var updateCmd = _p1._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			default:
				var _p5 = _p0._0;
				var _p2 = _p5;
				if (_p2.ctor === 'GotTimezone') {
					var _p3 = A2(_user$project$CitySelector$update, _p5, model.city);
					var updatedModel = _p3._0;
					var updateCmd = _p3._1;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{city: updatedModel, timeZone: _p2._0}),
						{
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Participant$CityMsg, updateCmd),
							_1: {ctor: '[]'}
						});
				} else {
					var _p4 = A2(_user$project$CitySelector$update, _p5, model.city);
					var updatedModel = _p4._0;
					var updateCmd = _p4._1;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
...
var _user$project$Participant$ToggleManual = {ctor: 'ToggleManual'};
var _user$project$Participant$Remove = {ctor: 'Remove'};
var _user$project$Participant$ShiftTimeZone = function (a) {
	return {ctor: 'ShiftTimeZone', _0: a};
};
var _user$project$Participant$getInput = function (model) {
	return model.isManual ? A2(
		_elm_lang$html$Html$map,
		_user$project$Participant$NumberInputMsg,
		A4(
			_user$project$App_NumberInput$view,
			model.numberInput,
			_elm_lang$core$Basics$toFloat(model.timeZone),
			1,
			function (_p6) {
				return _user$project$Participant$ShiftTimeZone(
					_elm_lang$core$Basics$floor(_p6));
			})) : A2(
		_elm_lang$html$Html$map,
		_user$project$Participant$CityMsg,
		_user$project$CitySelector$view(model.city));
};
var _user$project$Participant$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('app__participant participant'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$checked(model.isManual),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Participant$ToggleManual),
									_1: {ctor: '[]'}
								}
							}
						},
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Set timezone mannually'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Participant$getInput(model),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$button,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('participant__remove'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Participant$Remove),
								_1: {ctor: '[]'}
							}
						},
						{
...
var _user$project$ListRotate$rotate = F2(
	function (shift, list) {
		var normalizedshift = A2(
			_elm_lang$core$Basics$rem,
			shift,
			_elm_lang$core$List$length(list));
		return (_elm_lang$core$Native_Utils.cmp(shift, 0) > -1) ? A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$List$drop, normalizedshift, list),
			A2(_elm_lang$core$List$take, normalizedshift, list)) : A2(
			_elm_lang$core$Basics_ops['++'],
			A2(
				_elm_lang$core$List$drop,
				_elm_lang$core$List$length(list) + normalizedshift,
				list),
			A2(
				_elm_lang$core$List$take,
				_elm_lang$core$List$length(list) + normalizedshift,
...
var _user$project$Timeline$view = F3(
	function (shift, goodHours, attributes) {
		return A2(
			_elm_lang$html$Html$div,
			A2(
				_elm_lang$core$Basics_ops['++'],
			...
			A2(
					...
					return A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _elm_lang$html$Html_Attributes$classList(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'timeline__item', _1: true},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'timeline__item--good',
											_1: A2(_elm_lang$core$List$member, number, goodHours)
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
												_0: 'timeline__item--bad',
												_1: !A2(_elm_lang$core$List$member, number, goodHours)
											},
											_1: {ctor: '[]'}
										}
				...
				A2(
					_user$project$ListRotate$rotate,
					shift,
					A2(_elm_lang$core$List$range, 0, 23))));
	});

var _user$project$ParticipantTimeline$matchesGoodTime = F3(
	function (participant, startTime, duration) {
		var endMeeting = startTime + duration;
		var startMeeging = startTime;
		var endGoodTime = _elm_lang$core$Basics$toFloat(
			A2(
				F2(
					function (x, y) {
						return x + y;
				...
				A3(
					...
					A2(
						_elm_lang$core$Maybe$withDefault,
						24,
						_elm_lang$core$List$maximum(participant.goodHours)))));
		var startGoodTime = _elm_lang$core$Basics$toFloat(
			A3(
				_elm_lang$core$Basics$flip,
				F2(
					function (x, y) {
				...
				A2(
					_elm_lang$core$Maybe$withDefault,
					0,
					_elm_lang$core$List$minimum(participant.goodHours))));
		return (_elm_lang$core$Native_Utils.cmp(startGoodTime, startMeeging) < 1) && (_elm_lang$core$Native_Utils.cmp(endMeeting, endGoodTime) < 1);
	});
var _user$project$ParticipantTimeline$timelineClass = F3(
	function (participant, startTime, duration) {
		return A3(_user$project$ParticipantTimeline$matchesGoodTime, participant, startTime, duration) ? 'timeline--matches-meeting' : 'timeline--not-matches-meeting';
	});
var _user$project$ParticipantTimeline$view = F3(
	function (participant, startTime, duration) {
		return A3(
			_user$project$Timeline$view,
			participant.timeZone,
			participant.goodHours,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					A3(_user$project$ParticipantTimeline$timelineClass, participant, startTime, duration)),
				_1: {ctor: '[]'}
			});
	});
...
var _user$project$App$Model = F2(
	function (a, b) {
		return {participants: a, meetingTimeSelector: b};
	});
var _user$project$App$init = {
	...
	_0: A2(
		...
		_elm_lang$core$Array$fromList(
			{
				ctor: '::',
				_0: _user$project$Participant$init,
				_1: {
					ctor: '::',
					_0: _user$project$Participant$init,
					_1: {
		...
		_user$project$MeetingTimeSelector$init),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$App$Place = F2(
	function (a, b) {
		return {description: a, place_id: b};
	});
var _user$project$App$MeetingTimeSelectorMsg = function (a) {
	return {ctor: 'MeetingTimeSelectorMsg', _0: a};
};
var _user$project$App$ParticipantMsg = F2(
	function (a, b) {
		return {ctor: 'ParticipantMsg', _0: a, _1: b};
	});
			...
			case 'AddParticipant':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							participants: A2(_elm_lang$core$Array$push, _user$project$Participant$init, model.participants)
						}),
					{ctor: '[]'});
			case 'ParticipantMsg':
				var _p4 = _p0._1;
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								participants: A2(
									...
									A3(_elm_lang$core$Array$slice, 0, _p3, model.participants),
									A3(
										_elm_lang$core$Array$slice,
										_p3 + 1,
										_elm_lang$core$Array$length(model.participants),
										model.participants))
							}),
						{ctor: '[]'});
				} else {
					var _p2 = A2(
						_user$project$Participant$update,
						_p4,
						A2(
							_elm_lang$core$Maybe$withDefault,
							_user$project$Participant$init,
							A2(_elm_lang$core$Array$get, _p3, model.participants)));
					var updatedParticipant = _p2._0;
					var updateCmd = _p2._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								participants: A3(_elm_lang$core$Array$set, _p3, updatedParticipant, model.participants)
							}),
						_1: A2(
							_elm_lang$core$Platform_Cmd$map,
							_user$project$App$ParticipantMsg(_p3),
							updateCmd)
					};
				}
			default:
				var _p5 = A2(_user$project$MeetingTimeSelector$update, _p0._0, model.meetingTimeSelector);
				var updatedModel = _p5._0;
				var updateCmd = _p5._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{meetingTimeSelector: updatedModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App$MeetingTimeSelectorMsg, updateCmd)
				};
		}
	});
var _user$project$App$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$core$Platform_Sub$batch(
						...
						F2(
							function (index, p) {
								return A2(
									_elm_lang$core$Platform_Sub$map,
									function (p1) {
										return A2(_user$project$App$ParticipantMsg, index, p1);
									},
									_user$project$Participant$subsctiption(p));
							}),
						model.participants))),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$App$MeetingTimeSelectorMsg,
					_user$project$MeetingTimeSelector$subsctiption(model.meetingTimeSelector)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$App$AddParticipant = {ctor: 'AddParticipant'};
	...
	return A2(
		...
		},
		{
			...
			_0: _user$project$Header$view(
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('app__header app__component'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('app__participants app__component'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('app__add-participant'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$App$AddParticipant),
									_1: {ctor: '[]'}
								}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Add participant'),
								_1: {ctor: '[]'}
							}),
							...
							A2(
								...
								F2(
									function (index, participant) {
										return A2(
											_elm_lang$html$Html$map,
											_user$project$App$ParticipantMsg(index),
											_user$project$Participant$view(participant));
									}),
								model.participants))
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('app__timelines app__component'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(_user$project$MeetingIndicator$view, model.meetingTimeSelector.startTime, model.meetingTimeSelector.duration),
							_1: _elm_lang$core$Array$toList(
								A2(
									_elm_lang$core$Array$map,
									function (participant) {
										return A3(_user$project$ParticipantTimeline$view, participant, model.meetingTimeSelector.startTime, model.meetingTimeSelector.duration);
									},
									model.participants))
						}),
					_1: {
						...
						_0: A2(
							...
							_user$project$App$MeetingTimeSelectorMsg,
							A2(
								_user$project$MeetingTimeSelector$view,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('app__meeting app__component'),
									_1: {ctor: '[]'}
								},
								model.meetingTimeSelector)),
						_1: {ctor: '[]'}
					}
				}
			}
...
if (typeof _user$project$App$main !== 'undefined') {
    _user$project$App$main(Elm['App'], 'App', {"types":{"unions":{"CitySelector.Msg":{"args":[],"tags":{"GotTimezone":["Int"],"OnFocus":[],"Deb":["Debounce.Msg CitySelector.Msg"],"HandleEscape":[],"GotSuggestions":["List TeleportCitiesSuggestions.Suggestion"],"SelectPlaceKeyboard":["String"],"PreviewPlace":["String"],"GetSuggestions":[],"Wrap":["Bool"],"SetAutoState":["Autocomplete.Msg"],"SelectPlaceMouse":["String"],"Reset":[],"SetQuery":["String"],"NoOp":[]}},"Participant.Msg":{"args":[],"tags":{"NumberInputMsg":["App.NumberInput.Msg Participant.Msg"],"ToggleManual":[],"Remove":[],"ShiftTimeZone":["Int"],"CityMsg":["CitySelector.Msg"]}},"MeetingTimeSelector.Msg":{"args":[],"tags":{"DurationNumberInputMsg":["App.NumberInput.Msg MeetingTimeSelector.Msg"],"ShiftStartTime":["Float"],"StartTimeNumberInputMsg":["App.NumberInput.Msg MeetingTimeSelector.Msg"],"ShiftDuration":["Float"]}},"App.Msg":{"args":[],"tags":{"MeetingTimeSelectorMsg":["MeetingTimeSelector.Msg"],"ParticipantMsg":["Int","Participant.Msg"],"AddParticipant":[]}},"Debounce.Msg":{"args":["msg"],"tags":{"Raw":["msg"],"Deferred":["Int","msg"]}},"Autocomplete.Msg":{"args":[],"tags":{"Msg":["Autocomplete.Autocomplete.Msg"]}},"Autocomplete.Autocomplete.Msg":{"args":[],"tags":{"MouseLeave":["String"],"WentTooHigh":[],"WentTooLow":[],"MouseClick":["String"],"KeyDown":["Char.KeyCode"],"NoOp":[],"MouseEnter":["String"]}},"App.NumberInput.Msg":{"args":["msg"],"tags":{"EndRepeat":[],"Do":["msg"],"StartRepeat":["msg"],"SetOverrideValue":["String"]}}},"aliases":{"Char.KeyCode":{"args":[],"type":"Int"},"TeleportCitiesSuggestions.Suggestion":{"args":[],"type":"{ id : String, name : String }"}},"message":"App.Msg"},"versions":{"elm":"0.18.0"}});
}
